  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-24 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        {/* Background glow */}
        <div className="absolute top-20 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-emerald-100 rounded-full blur-3xl pointer-events-none opacity-60" />
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              ...
              <Link
                href="/dashboard"
                className="bg-white hover:bg-gray-50 text-gray-700 font-semibold px-8 py-4 rounded-xl text-lg transition-colors border border-gray-200 flex items-center justify-center gap-2 shadow-sm"
              >
                Ver Demo
              </Link>
            </div>
          ...
          <div className="mt-16 relative max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-xl">
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="ml-2 text-gray-400 text-sm">PetDiet Pro – Dashboard</span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
                {[
                  { label: "Calorias Hoje", value: "420 kcal", icon: "🔥", color: "text-orange-500" },
                  { label: "Proteína", value: "28g / 32g", icon: "💪", color: "text-blue-500" },
                  { label: "Hidratação", value: "85%", icon: "💧", color: "text-cyan-500" },
                ].map((stat) => (
              ...
              <div className="bg-gray-50 rounded-xl p-4">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-gray-700 text-sm font-medium">Progresso Nutricional – Max 🐕</span>
                  <span className="text-emerald-600 text-xs">Hoje</span>
                </div>
                <div className="space-y-2">
                  {[
                    ...
                    <div key={item.label} className="flex items-center gap-3">
                      <span className="text-gray-500 text-xs w-24">{item.label}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.step} className="text-center">
                ...
                <div className="text-emerald-600 font-bold text-sm mb-2">PASSO {item.step}</div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-br from-emerald-50 to-blue-50 border border-emerald-100 rounded-3xl p-12">
      ...
      {/* Disclaimer Banner */}
      <section className="py-6 px-4 bg-amber-50 border-y border-amber-100">
        <div className="max-w-7xl mx-auto flex items-start gap-3">
          <Shield className="w-5 h-5 text-amber-500 flex-shrink-0 mt-0.5" />
          <p className="text-amber-700 text-sm">
            <strong className="text-amber-600">Aviso Legal:</strong> O PetDiet Pro é uma ferramenta de apoio e não substitui a consulta veterinária profissional.
            Sempre consulte um médico veterinário antes de fazer alterações significativas na dieta do seu animal.{" "}
            <Link href="/legal" className="underline hover:text-amber-800">
              Saiba mais
            </Link>
          </p>
        </div>
