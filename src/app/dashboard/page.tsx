        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-8 pt-6">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Bem-vindo de volta! Aqui está o resumo dos seus pets.</p>
            </div>
            <button
          ...
          <div className="flex gap-3 mb-8 overflow-x-auto pb-2">
            ...
            <button
              onClick={() => setShowAddPet(true)}
              className="flex items-center gap-2 px-4 py-3 rounded-xl border border-dashed border-gray-300 text-gray-400 hover:border-emerald-400 hover:text-emerald-600 transition-all flex-shrink-0"
            >
              <Plus className="w-4 h-4" />
          ...
          {/* Tabs */}
          <div className="flex gap-1 bg-white border border-gray-200 rounded-xl p-1 mb-8 overflow-x-auto shadow-sm">
            {[
          ...
          {activeTab === "overview" && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-gray-500 text-sm">Calorias</span>
                  </div>
                  <div className="text-2xl font-bold text-gray-900">{activePet.calories.consumed}</div>
                  <div className="text-gray-400 text-xs">de {activePet.calories.target} kcal</div>
                  ...
                  <div className="text-xs text-gray-400 mt-1">{caloriesPct}% do objetivo</div>
                </div>

                <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                  <div className="flex items-center gap-2 mb-3">
                    <Droplets className="w-5 h-5 text-cyan-500" />
                    <span className="text-gray-500 text-sm">Hidratação</span>
                  </div>
                  <div className="text-2xl font-bold text-gray-900">{activePet.water}%</div>
                  <div className="text-gray-400 text-xs">do objetivo diário</div>
                  <div className="mt-3 bg-gray-100 rounded-full h-2">
                    <div
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                  ...
                  <div className="text-2xl font-bold text-gray-900">{activePet.weight} kg</div>
                  <div className="text-gray-400 text-xs">Peso atual</div>
                  <div className="text-emerald-600 text-xs mt-2">✓ Peso ideal</div>
                </div>

                <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                  <div className="flex items-center gap-2 mb-3">
                    <PawPrint className="w-5 h-5 text-purple-500" />
                    <span className="text-gray-500 text-sm">Saúde Geral</span>
                  </div>
                  <div className="text-2xl font-bold text-emerald-600">Boa</div>
                  <div className="text-gray-400 text-xs">Baseado nos dados</div>
                  <div className="text-gray-400 text-xs mt-2">Última atualização: hoje</div>
                </div>
              </div>
                  ...
                  {[
                    ...
                    <div key={item.label}>
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-gray-400 text-xs">{item.current} / {item.target}</span>
                      </div>
                      ...
                      <div className="text-right text-xs text-gray-400 mt-0.5">{item.pct}%</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Alerts */}
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <h3 className="text-gray-900 font-semibold mb-4">Alertas e Notificações</h3>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-gray-900 font-semibold">Refeições Recentes</h3>
                  <button className="text-emerald-600 text-sm hover:text-emerald-700">+ Adicionar</button>
                </div>
                <div className="space-y-3">
                  {recentMeals.filter(m => m.pet === activePet.name).map((meal, i) => (
                    <div key={i} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                      <div className="flex items-center gap-3">
                        <span className="text-gray-400 text-xs w-12">{meal.time}</span>
                        <div>
                          <div className="text-gray-700 text-sm">{meal.food}</div>
                          <div className="text-gray-400 text-xs">{meal.amount}</div>
                        </div>
                      </div>
                      <div className="text-orange-500 text-sm font-medium">{meal.calories} kcal</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Download Report */}
              <div className="bg-gradient-to-r from-emerald-50 to-blue-50 border border-emerald-100 rounded-xl p-6 flex items-center justify-between">
                <div>
                  <h3 className="text-gray-900 font-semibold mb-1">Exportar Relatório</h3>
                  <p className="text-gray-500 text-sm">Descarregue um relatório completo em PDF com todos os dados nutricionais.</p>
                </div>
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="text-gray-700 font-medium mb-4">Dados do Pet</h4>
                    <div className="space-y-3">
                      {[
                  ...
                  <div>
                    <h4 className="text-gray-700 font-medium mb-4">Necessidades Calculadas</h4>
                    <div className="space-y-4">
                      <div className="bg-gray-50 rounded-xl p-4 text-center">
                        <div className="text-4xl font-bold text-emerald-600">{activePet.calories.target}</div>
                        <div className="text-gray-500 text-sm mt-1">kcal / dia (RER × fator)</div>
                      </div>
                  ...
                  {[
                    ...
                    <div key={nutrient.name} className="bg-gray-50 rounded-xl p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-gray-900 font-medium">{nutrient.name}</span>
                      ...
                      <p className="text-gray-400 text-xs">{nutrient.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={item.food} className="flex items-center justify-between bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2">
                          <span className="text-gray-700 text-sm">✅ {item.food}</span>
                          <span className="text-gray-400 text-xs">{item.benefit}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        <div key={item.food} className="flex items-center justify-between bg-red-50 border border-red-200 rounded-lg px-3 py-2">
                          <span className="text-gray-700 text-sm">❌ {item.food}</span>
                          <span className="text-red-500 text-xs">{item.risk}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={supp.name} className={`border rounded-xl p-4 ${supp.bg}`}>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-gray-900 font-medium">{supp.name}</span>
                        <span className={`text-xs font-medium ${supp.color}`}>{supp.priority}</span>
                      </div>
                      <div className="text-gray-500 text-xs mb-1">Dose: {supp.dose}</div>
                      <div className="text-gray-400 text-xs">{supp.benefit}</div>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {showAddPet && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white border border-gray-200 rounded-2xl p-6 w-full max-w-md shadow-xl">
            <h3 className="text-gray-900 font-bold text-xl mb-6">Adicionar Novo Pet</h3>
            <div className="space-y-4">
              {[
                ...
                <div key={field.label}>
                  <label className="text-gray-700 text-sm font-medium block mb-1">{field.label}</label>
                  <input
                    type={field.type}
                    placeholder={field.placeholder}
                    className="w-full bg-gray-50 border border-gray-300 text-gray-900 rounded-lg px-3 py-2.5 text-sm focus:outline-none focus:border-emerald-500"
                  />
                </div>
              ))}
            </div>
