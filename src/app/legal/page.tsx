        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 bg-amber-500/10 border border-amber-500/30 rounded-full px-4 py-2 mb-4">
              ...
              <span className="text-amber-400 text-sm font-medium">Informação Legal</span>
            </div>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-5 mb-10">
            <h3 className="text-white font-medium mb-3">Navegação Rápida</h3>
          ...
          <div className="space-y-8">
            {/* Disclaimer */}
            <section id="disclaimer" className="bg-slate-800 border border-slate-700 rounded-xl p-8">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-red-500/10 rounded-xl flex items-center justify-center">
                  <Info className="w-5 h-5 text-red-400" />
                </div>
                <h2 className="text-white font-bold text-xl">Disclaimer</h2>
              </div>
            ...
            {/* Responsabilidade */}
            <section id="responsabilidade" className="bg-slate-800 border border-slate-700 rounded-xl p-8">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-orange-500/10 rounded-xl flex items-center justify-center">
                  <Scale className="w-5 h-5 text-orange-400" />
                </div>
                <h2 className="text-white font-bold text-xl">Responsabilidade</h2>
              </div>
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <h3 className="text-white font-semibold">Limitação de Responsabilidade</h3>
                <p>
                ...
                <h3 className="text-white font-semibold mt-4">Responsabilidade do Utilizador</h3>
                <p>
            ...
            {/* Uso da Informação */}
            <section id="uso-informacao" className="bg-slate-800 border border-slate-700 rounded-xl p-8">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-blue-500/10 rounded-xl flex items-center justify-center">
                  <FileText className="w-5 h-5 text-blue-400" />
                </div>
                <h2 className="text-white font-bold text-xl">Uso da Informação</h2>
              </div>
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
            ...
            {/* Privacidade */}
            <section id="privacidade" className="bg-slate-800 border border-slate-700 rounded-xl p-8">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-emerald-500/10 rounded-xl flex items-center justify-center">
                  <Lock className="w-5 h-5 text-emerald-400" />
                </div>
                <h2 className="text-white font-bold text-xl">Política de Privacidade</h2>
              </div>
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <h3 className="text-white font-semibold">Dados Recolhidos</h3>
                ...
                <h3 className="text-white font-semibold mt-4">Uso dos Dados</h3>
                ...
                <h3 className="text-white font-semibold mt-4">Os Seus Direitos (RGPD)</h3>
                ...
                <p>
                  ...
                  <a href="mailto:privacidade@petdietpro.com" className="text-emerald-400 hover:underline">
            ...
            {/* Termos de Uso */}
            <section id="termos" className="bg-slate-800 border border-slate-700 rounded-xl p-8">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-purple-500/10 rounded-xl flex items-center justify-center">
                  <FileText className="w-5 h-5 text-purple-400" />
                </div>
                <h2 className="text-white font-bold text-xl">Termos de Uso</h2>
              </div>
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <p>
            ...
            {/* Pagamentos */}
            <section id="pagamentos" className="bg-slate-800 border border-slate-700 rounded-xl p-8">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 bg-cyan-500/10 rounded-xl flex items-center justify-center">
                  <Shield className="w-5 h-5 text-cyan-400" />
                </div>
                <h2 className="text-white font-bold text-xl">Política de Pagamentos e Reembolsos</h2>
              </div>
              <div className="space-y-4 text-slate-300 leading-relaxed">
                <h3 className="text-white font-semibold">Subscrições</h3>
                <ul className="list-disc list-inside space-y-2 text-slate-400 ml-4">
                ...
                <h3 className="text-white font-semibold mt-4">Cancelamento</h3>
                <p>
                ...
                <h3 className="text-white font-semibold mt-4">Garantia de Reembolso</h3>
                <p>
                ...
                <h3 className="text-white font-semibold mt-4">Processamento de Pagamentos</h3>
                <p>
            ...
            <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-6 text-center">
              <h3 className="text-white font-semibold mb-2">Dúvidas Legais?</h3>
